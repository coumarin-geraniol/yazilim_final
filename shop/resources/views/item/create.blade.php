                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"
                                           placeholder="Ürün ismi Giriniz" value="{{ old('title') }}">
                                    @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="description" id="description"
                                           placeholder="Ürün açıklaması Giriniz" value="{{ old('description') }}"
                                    >
                                    @error('description')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control" id="content" cols="30" rows="12"
                                              placeholder="Ürün detaylarını Giriniz">{{ old('content') }}</textarea>
                                    @error('content')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="price" id="price"
                                           placeholder="Ürün fiyatı Giriniz" value="{{ old('price') }}">
                                    @error('price')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="quantity" id="quantity"
                                           placeholder="Ürün sayısı Giriniz" value="{{ old('quantity') }}">
                                    @error('quantity')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <select name="type" class="form-control">
                                        ...
                                        @foreach($types as $id => $type)
                                            <option value="{{ $id }}" {{ $id == old('type') ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group select2-primary">
                                    ...
                                    <select class="select2" name="tag_ids[]" multiple="multiple" style="width: 100%;">
                                        @foreach($tags as $tag)
                                            <option
                                                value="{{ $tag->id }}" {{ is_array(old('tag_ids')) && in_array($tag->id, old('tag_ids')) ? 'selected' : '' }}>
                                                {{ $tag->title }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <div class="mb-2">
                                        <img class="preview_image" id="preview_image" src="#" alt="preview_image" class="img-fluid" style="display: none;"/>
                                    </div>
                                </div>
                            </div>
                        </div>
